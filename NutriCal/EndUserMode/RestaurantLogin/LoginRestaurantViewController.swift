...
// Login as a restaurant to add items and menus

class LoginRestaurantViewController: LoginBaseViewController, LoginControllerType {
...
extension LoginRestaurantViewController: LoginBaseViewControllerDelegate {
